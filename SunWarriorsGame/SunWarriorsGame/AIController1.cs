...
namespace SunWarriorsGame
{
    class AIController1
    {
        ...
        public void startAI1()
        {
            ...
            for (int i = 0; i < 150; i++)
            {
                //Point p = gameEngine.getMyTank().getPosition();
                AImove(mygame.move());
                Thread.Sleep(3000);
            }
        }
        ...
        private int[] array = {4,4,4,4,4,4,4,4,3,3,3,3,3,5,5,5,3,3,3,3,2,5,5,4,4,4,4,4,1,5,5,2,5,3,3,3,3,3,3,2,5,5,4,4,5,5,3,3,2,5,5,4,4,4,4,3,5,5,5,4,4,4,5,5,
            2,2,3,3,1,1,2,2,1,1,3,3,4,4,3,3,3,4,5,5,4,4,2,2,3,
            3,1,1,5,5,5,2,5,5,2,4,4,1,5,1,3,3,3,3,5,5,5,4,4,4,
            2,5,5,4,4,5,5,3,3,3,3,3,3,4,4,5,5,5,3,3,2,2,3,2,4};
    }
}
